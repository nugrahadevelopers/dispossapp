...
export default function Authenticated({ auth, header, children }) {
    ...
    const adminLevel = auth.user.level == 1;

    return (
        <div className="min-h-screen bg-green-50 flex flex-row">
            <div className="w-1/6 bg-green-600 py-20 px-10">
                    ...
                    {adminLevel ? (
                        <>
                            ...
                            <NavLink
                                ...
                                active={route().current("pembelian")}
                            >
                                Pembelian
                            </NavLink>
                            <NavLink
                                href={route("penjualan")}
                                active={route().current("penjualan")}
                            >
                                Penjualan
                            </NavLink>
                            <NavLink
                            ...
                            <NavLink
                                href={route("transaksi_penjualan")}
                                active={route().current("transaksi_penjualan")}
                            >
                                Transaksi Aktif
                            </NavLink>
                            <NavLink
                                href={route("penjualan.create")}
                                active={route().current("penjualan.create")}
                            >
                                Transaksi Baru
                            </NavLink>
                            <div className="inline-flex items-center text-sm font-semibold text-green-900">
